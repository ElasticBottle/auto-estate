    ...
    <div className="p-5 space-y-6 md:p-10">
      ...
      <article>
        <section>
          ...
          mortgage is the largest debt they would ever take on in their lives.
          To make the process easier the Government of Canada has a few
          financial tools and programs that help you with both saving up for
          down payments and help reduce your monthly payments.
        </section>
        <section className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-10">
          ...
          <div className="space-y-4">
            <section>
              This program can be thought as a second mortgage in addition to
              your original mortgage. The program works in a way such that the
              Government becomes a 5 or 10% equity owner in your home and
              becomes a co-owner. This way either the amount is required to be
              returned after 25 years or the equity value of the house is to be
              returned to the Government upon sale.
            </section>
            <section>
              ...
              <ul className="list-disc ml-5">
                ...
                <li>
                  Your total borrowing is no more that 4 times your annual
                  income
                </li>
                <li>
                  You or your spouse are a first time home buyer or have not
                  owned a house for the last 4 years
                </li>
                <li>
                  You meet the requirements to make a 5% down payment in the
                ...
                <li>
                  You are buying the house as your primary residence and must
                  move in within 1 year of closing the purchase
                </li>
              </ul>
            </section>
            <section>
              <span className="font-bold">Benefits of the Program:</span>
              <ul className="ml-5 list-disc">
                ...
                <li>
                  ...
                  fourplex, Town Houses, Condominium Units and semi-detached
                  homes
                </li>
                <li>
                  ...
                  government incurs a part of the loss proportional to its
                  equity
                </li>
              </ul>
            </section>
        ...
        <section className="grid md:grid-cols-2 grid-cols-1 gap-6 mt-10">
          <h2 className="font-bold md:col-span-2">Home Buyer's Plan</h2>
          <section className="space-y-4">
            <p>
              The Home Buyer’s Plan is actually one of the few withdrawal
              clauses of the RRSP program. This plan allows Investors to
              withdraw upto CA$ 35,000 from their RRSP fund, which makes this
              amount essential tax free as all the funds in RRSP can be tax
              written off.
            </p>
            <section>
              <span className="font-bold"> Eligibility Requirements:</span>
          ...
          <section>
            ...
            <ul className="ml-5 list-disc">
              ...
              <li>
                The repayment to the RRSP can be done over a period over the
                next year, esentially making your RRSP provide you an interest
                free loan
              </li>
              <li>
                Both you and your spouse can withdraw from their respective
                RRSP, saving a lot in taxes and bringing the downpayment to 20%
